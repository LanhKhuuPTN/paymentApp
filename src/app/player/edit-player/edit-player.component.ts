...
export class EditPlayerComponent implements OnInit {
  ...
  imagePath: string;
  id: string;
 optionPosition: string[]=["Striker","Goalkeeper","Right Back","Left Back","Centre Back","Central Defensive"
 ,"Attacking Midfielders","Midfielder"];
  ...
  addPlayer(){
    ...
    this.service.postPaymentDetail1(this.formData).subscribe(res =>{
     alert("Add Success!!");
  ...
  updatePlayer(){
   ...
   console.log(this.formData.get("imageName"));
    this.service.putPaymentDetail(this.player.id,this.formData).subscribe(res =>{
